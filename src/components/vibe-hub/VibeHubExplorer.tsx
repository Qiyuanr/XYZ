...
export function VibeHubExplorer() {
  ...
  return (
    <section className={`${styles.section} ${styles.explorer}`} id="explorer">
      ...
      {detailLoading ? (
        <p className={styles.statusMessage}>正在读取术语详情…</p>
      ) : null}
            ...
            >
              ...
              {practiceChoice !== null ? (
                <p className={styles.practiceFeedback} aria-live="polite">
                  <strong>
                    {lesson.lessonPractice.options[practiceChoice].correct
                      ? "回答正确"
                      : "再想一步"}
                  </strong>
            ...
            <section className={styles.flow}>
              ...
              <ol>
                {lesson.flowLesson.steps.map(step => (
                  <li
                    className={step.focused ? styles.focusedStep : undefined}
                    key={step.id}
                  >
