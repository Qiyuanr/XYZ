    ...
    terms: [
      {
        ...
        prompt: "执行保存、取消等当前页面动作。",
      },
      {
        id: "link",
        title: "链接",
        secondaryTitle: "Link",
        prompt: "前往另一页面、页内位置或外部资源。",
      },
    ],
  },
  {
    ...
    terms: [
      {
        id: "input",
        title: "输入框",
        secondaryTitle: "Input",
        prompt: "填写邮箱、名称等单行内容。",
      },
      {
        id: "textarea",
        title: "多行文本框",
        secondaryTitle: "Textarea",
        prompt: "输入一段较长的文字。",
      },
      {
        id: "input-number",
        title: "数字输入框",
        secondaryTitle: "InputNumber",
        prompt: "直接输入数字，也可以按加减调整。",
      },
      {
        id: "radio",
        title: "单选框",
        secondaryTitle: "Radio",
        prompt: "一组选项中只能选择一个。",
      },
      {
        id: "checkbox",
        title: "复选框",
        secondaryTitle: "Checkbox",
        prompt: "多个选项可以同时选择。",
      },
      {
        id: "switch",
        title: "开关",
        secondaryTitle: "Switch",
        prompt: "在开启与关闭之间切换。",
      },
      {
        id: "slider",
        title: "滑块",
        secondaryTitle: "Slider",
        prompt: "拖动选择一个连续范围内的值。",
      },
      {
        id: "rate",
        title: "评分",
      ...
      },
      {
        id: "select",
        title: "选择器",
        secondaryTitle: "Select",
        prompt: "从收起的选项列表中选择。",
      },
      {
        id: "date-picker",
        title: "日期选择器",
        secondaryTitle: "DatePicker",
        prompt: "通过系统日历选择日期。",
      },
      {
        id: "upload",
        title: "上传",
        secondaryTitle: "Upload",
        prompt: "选择本地文件并显示文件名，不会上传。",
      },
    ],
  },
  {
    ...
    terms: [
      {
        ...
        title: "标签页",
        secondaryTitle: "Tabs",
        prompt: "点击页签切换同一区域里的内容。",
      },
      {
        id: "collapse",
        title: "折叠面板",
        secondaryTitle: "Collapse",
        prompt: "按需展开或收起一段内容。",
      },
      {
        id: "carousel",
        title: "走马灯",
        secondaryTitle: "Carousel",
        prompt: "使用左右按钮切换多张内容卡片。",
      },
      {
        id: "badge",
        title: "徽标",
        secondaryTitle: "Badge",
        prompt: "在图标旁提示未读数量。",
      },
      {
        id: "progress",
        title: "进度条",
        secondaryTitle: "Progress",
        prompt: "展示任务当前完成到哪一步。",
      },
      {
        id: "skeleton",
        title: "骨架屏",
        secondaryTitle: "Skeleton",
        prompt: "加载时先显示内容轮廓占位。",
      },
    ],
  },
    ...
    terms: [
      {
        ...
        prompt: "持续展示一条需要注意的信息。",
      },
      {
        id: "toast",
        title: "轻提示",
        secondaryTitle: "Toast",
        prompt: "动作完成后短暂出现，再自动消失。",
      },
      {
        id: "modal",
        title: "弹窗",
        secondaryTitle: "Modal",
        prompt: "在当前页面上方集中处理一件事。",
      },
      {
        id: "drawer",
        title: "抽屉",
        secondaryTitle: "Drawer",
        prompt: "从侧边滑出面板，同时保留页面背景。",
      },
      {
        id: "tooltip",
        title: "文字提示",
        secondaryTitle: "Tooltip",
        prompt: "悬停或键盘聚焦时显示短说明。",
      },
      {
        id: "popconfirm",
        title: "气泡确认框",
        secondaryTitle: "Popconfirm",
        prompt: "在危险按钮附近进行一次轻量确认。",
      },
    ],
  },
  {
    ...
    terms: [
      ...
      },
      {
        id: "steps",
        title: "步骤条",
        secondaryTitle: "Steps",
        prompt: "展示流程阶段与当前所在步骤。",
      },
      {
        id: "dropdown",
        title: "下拉菜单",
        secondaryTitle: "Dropdown",
        prompt: "点击后展开一组临时操作。",
      },
      {
        id: "search",
        title: "搜索",
        secondaryTitle: "Search",
        prompt: "输入关键词即时筛选可能相关的结果。",
      },
    ],
  },
];
...
export function TermDemo({
  ...
  switch (termId) {
        ...
        <div className={styles.buttonDemo}>
          <div className={styles.demoActions}>
            <button
              ...
              type="button"
              onClick={() =>
                setActionMessage("演示：已触发保存动作，不会保存真实数据")
              }
            >
              保存
            </button>
            <button
              ...
              type="button"
              onClick={() => setActionMessage("演示：已取消本次修改")}
            >
              取消
            </button>
          </div>
      ...
      content = (
        <label className={styles.demoField} htmlFor={`${fieldId}-textarea`}>
          ...
          <textarea
            ...
            value={textareaValue}
            onChange={event =>
              setTextareaValue(event.target.value.slice(0, 80))
            }
            placeholder="写下一段说明…"
          />
        ...
        <div className={styles.numberDemo}>
          ...
          <div>
            <button
              ...
              aria-label="数量减一"
              disabled={quantity <= 1}
              onClick={() => setQuantity(value => clamp(value - 1, 1, 20))}
            >
              −
            </button>
            <input
        ...
        <div className={styles.carouselDemo}>
          <button
            ...
            onClick={() =>
              setCarouselIndex(
                value =>
                  (value + carouselItems.length - 1) % carouselItems.length
              )
            }
          >
            ←
          ...
          <div>
            ...
            <strong>{carouselItems[carouselIndex]}</strong>
          </div>
          <button
            type="button"
            aria-label="下一张"
            onClick={() =>
              setCarouselIndex(value => (value + 1) % carouselItems.length)
            }
          >
            →
          </button>
    ...
    case "badge":
      content = (
        <div className={styles.badgeDemo}>
          <button
            type="button"
            aria-label={`${badgeCount} 条未读消息`}
            onClick={() => setBadgeCount(0)}
          >
            消息 <span>{badgeCount || "✓"}</span>
          </button>
          <small>点击后标记已读</small>
        </div>
      );
      ...
      content = (
        <div className={styles.progressDemo}>
          ...
          <button
            ...
            onClick={() =>
              setProgress(value =>
                value >= 100 ? 0 : Math.min(100, value + 14)
              )
            }
          >
            推进进度
    ...
    case "alert":
      content = alertVisible ? (
        <div className={styles.alertDemo} role="alert">
          <span>!</span>
          <p>
            <strong>账号将在 3 天后到期</strong>
            <small>请及时续费，避免服务中断。</small>
          </p>
          <button
            type="button"
            aria-label="关闭提示"
        ...
        <div className={styles.overlayDemo}>
          ...
          {modalOpen ? (
            <div className={styles.modalBackdrop}>
              <div role="dialog" aria-modal="true" aria-label="确认发布">
                <strong>确认发布？</strong>
                <p>发布后其他人就能看到这篇内容。</p>
                <div className={styles.demoActions}>
                  <button
    ...
    case "tooltip":
      content = (
        <div className={styles.tooltipDemo}>
          <span role="tooltip" id={`${fieldId}-tooltip`}>
            复制链接
          </span>
          <button
            type="button"
        ...
        <div className={styles.popconfirmDemo}>
          {deleted ? (
            <div className={styles.popconfirmResult} role="status">
              ...
              <p>
                <strong>项目已删除</strong>
                <small>这里只改变演示状态，没有删除真实内容。</small>
              </p>
              <button type="button" onClick={() => setDeleted(false)}>
                重新演示
              </button>
            </div>
          ) : (
            <div className={styles.popconfirmAnchor}>
              {confirmOpen ? (
                <div
                  className={styles.popconfirmBubble}
                  role="dialog"
                  aria-label="确认删除"
                >
      ...
      content = (
        <div className={styles.paginationDemo} aria-label="分页">
          ...
          <button
            type="button"
            disabled={page === 4}
            onClick={() => setPage(value => Math.min(4, value + 1))}
          >
            →
          </button>
        </div>
    ...
    case "steps":
      content = (
        <div className={styles.stepsDemo}>
          <ol>
            {["填写信息", "确认订单", "完成付款"].map((item, index) => (
              <li data-active={index <= step} key={item}>
                <span>{index + 1}</span>
                <small>{item}</small>
              </li>
            ))}
  ...
  return (
    <div
      className={`${styles.termDemo} ${compact ? styles.termDemoCompact : ""}`}
    >
      {content}
    </div>
  );
